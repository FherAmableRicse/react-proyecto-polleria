        ...
        <div id="carouselExampleDark" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval="5000">
              <img src="https://i.postimg.cc/Jh6Z5YSy/Pachamanquero.jpg" className="d-block w-100" alt="Foto Conformación Empresa" />
              <div className="carousel-caption d-none d-md-block p-2 text-light bg-opacity-25">
                <button type="button" className="btn btn-danger mb-4 rounded-pill py-2 px-4">
                  <Link to="pedidos" className="btn-carousel text-decoration-none" >EMPIEZA TU PEDIDO AQUI</Link>
                </button>
              </div>
            </div>
            <div className="carousel-item" data-bs-interval="5000">
              <img src="https://i.postimg.cc/L4qpC5QC/lalena-perfectos-compartir.jpg" className="d-block w-100"
            ...
            <div className="carousel-item" data-bs-interval="5000">
              <img src="https://i.postimg.cc/7LCx2tkY/lalena-picaditos-banner.jpg" className="d-block w-100" alt="Foto grupo de Delivery" />
              <div className="carousel-caption d-none d-md-block p-2 text-light bg-opacity-25">
                <button type="button" className="btn btn-danger mb-4 rounded-pill py-2 px-4">
                  <Link to="pedidos" className="btn-carousel text-decoration-none" >EMPIEZA TU PEDIDO AQUI</Link>
                </button>
